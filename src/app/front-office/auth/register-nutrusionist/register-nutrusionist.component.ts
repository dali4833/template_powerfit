...
@Component({
  selector: 'app-register-nutrusionist',
  templateUrl: './register-nutrusionist.component.html',
  styleUrls: ['./register-nutrusionist.component.css']
})
export class RegisterNutrusionistComponent {
